          ...
          <form onSubmit={handleSendOtp} className="space-y-6">
            <div className="space-y-2">
              <div className="flex items-center gap-1">
                ...
                <HelpTooltip helpText="This is a real-time OTP App which uses your phone number and SMS for multi-factor authentication. NFC enabled DOBOTS are not necessary to use this App, but they Do))) make managing groups and events more fun! Go to dobots.co to learn more." />
              </div>
