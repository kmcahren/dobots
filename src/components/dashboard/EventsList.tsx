...
const mockEvents: EventItem[] = [
  ...
  { id: "3", title: "Championship Game Day", startDate: "Last Week", endDate: "", location: "Away Team Stadium", groupName: "Varsity Basketball Team", inviteesCount: 50, hostName: "Coach Miller", description: "The big game! Let's bring home the trophy.", hostUserId: "user3" }, // No imageUrl here
  ...
  { id: "5", title: "Weekend Coding Workshop", startDate: "Previous Weeks", endDate: "", location: "Tech Hub Co-working", groupName: "Developers United", inviteesCount: 25, hostName: "Alex P.", description: "Deep dive into new JavaScript frameworks.", hostUserId: "user5" }, // No imageUrl here
];
